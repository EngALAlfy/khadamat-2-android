                          ...
                          if (foundProducts.isNotEmpty) {
                            return ProductItem(
                              ...
                              ['highlight'] ==
                                  null
                                  ? false
                                  : foundProducts[i * productLimit + index]['highlight'] == '1' ? true : false,
                                ...
                                return GridView.builder(
                                  ...
                                  itemBuilder: (ctx, index) {
                                    return ProductItem(
                                      ...
                                      isHighlighted: snapshot.data[i * productLimit + index]['highlight'] == null
                                          ? false
                                          : snapshot.data[i * productLimit + index]['highlight'] == '1' ? true : false,
