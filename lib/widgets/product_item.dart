...
class _ProductItemState extends State<ProductItem> {
  ...
  Widget cancelButton(BuildContext ctx) {
    return TextButton(
      style: ButtonStyle(
        foregroundColor: MaterialStateProperty.all<Color>(Colors.grey[800] ?? Colors.white),
      ),
      child: Text(
        langPack['Cancel'],
  ...
  Widget build(BuildContext context) {
    ...
    return AspectRatio(
      ...
      child: GestureDetector(
        ...
        child: Card(
          elevation: 8,
          color: (widget.isHighlighted ?? false) ? Colors.yellow.shade600: Colors.white,
          shadowColor: Colors.black12,
          shape: RoundedRectangleBorder(
            side: BorderSide(color: Colors.grey[100]  ?? Colors.white, width: 1),
                      ...
                      child: FittedBox(
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            if (widget.isOnMyAdsScreen ?? false)
                              PopupMenuButton(
                                itemBuilder: (ctx) {
                                  final popUpItems = [
                                    PopupMenuItem(
                              ...
                              onPressed: () async {
                                if (!isFavorite) {
                                  ...
                                  await DBHelper.deleteFavProduct(
                                      DBHelper.favTableName, widget.id ?? "0");
                                }
                                setState(() {
